...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "Which town would be the best to explore with someone in a wheelchair?", "expects": "towns with flat terrain, no stairs/steps, and accessible facilities"},
